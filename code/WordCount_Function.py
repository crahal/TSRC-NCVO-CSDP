# -*- coding: utf-8 -*-
"""
-A function to count words in the input registers for the targetted
...
def countthewords(register_input, typeofmatches):
    # this is required because of some weird floats
    register_input = [b for b in register_input if isinstance(b, str)]
    # this is required to split the variable words in the cells up
    register_input = [
        words for segments in register_input for words in segments.split()]
    uniques = []
